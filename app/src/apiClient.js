const API_URL =
  document.getElementById('REACT_APP_API_URL') &&
  document.getElementById('REACT_APP_API_URL').value;
...
export function authenticateUser(username, password, callback) {
  ...
  const poolData = {
    UserPoolId:
      document.getElementById('REACT_APP_AWS_COGNITO_USER_POOL_ID') &&
      document.getElementById('REACT_APP_AWS_COGNITO_USER_POOL_ID').value,
    ClientId:
      document.getElementById('REACT_APP_AWS_COGNITO_CLIENT_ID') &&
      document.getElementById('REACT_APP_AWS_COGNITO_CLIENT_ID').value
  };
